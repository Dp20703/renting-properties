...
function Main() {
    ...
    const handlePropertyChange = (id, e) => {
        const updatedProperties = properties.map((property) =>
            property.id === id ? { ...property, [e.target.name]: e.target.value } : property
        );
    ...
    return (
        <div className="container-fluid bg-light vh-100 d-flex justify-content-center align-items-center" style={{ marginTop: '150px', marginBottom: "200px" }}>
            <div className="card shadow-lg p-4 text-center w-75">
                {/* Profile Section */}
                <img src={user.profilePic} alt="Profile" className="rounded-circle mb-3 m-auto" width="120" />
                                    ...
                                    {isEditingProperty === property.id ? (
                                        <>
                                            ...
                                            <textarea
                                                ...
                                                required
                                            ></textarea>
                                            <button className="btn btn-success me-2" onClick={() => handlePropertySave(property.id)}>
                                                Save
                                            </button>
                                            <button className="btn btn-secondary" onClick={() => setIsEditingProperty(null)}>
                                                Cancel
                                            </button>
                                        </>
                                    ) : (
