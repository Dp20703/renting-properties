...
const propertyDetails = {
    ...
    description: "This stunning property located in the heart of Bandra, Mumbai, offers a luxurious living experience with its spacious 2100 sqft area. The property features 8 rooms, including 5 bedrooms and 2 bathrooms, providing ample space for a large family. The modern design and high-quality finishes make this property a perfect blend of comfort and style.",
    features: [
        "Air Conditioning", "Balcony", "Front Yard", "Pool", "Attic", "Broadband",
        "Ground", "Parking", "Dining Space", "Back Yard"
    ],
    coreDetails: {
        size: "2100 sqft",
        rooms: 8,
                ...
                <div className="container py-md-3">
                                ...
                                <div className="gallery d-flex justify-content-center flex-wrap">
                                    {propertyDetails.images.map((img, index) => (
                                        <div key={index} className="large-image p-2">
                                            <img src={img} className="img-fluid rounded shadow" style={{ width: "100%", maxHeight: "500px", objectFit: "cover" }} alt={`Property Image ${index + 1}`} />
                                        </div>
                                    ))}
                                </div>
                            </div>
                    ...
                    <div className="row mt-5">
                        <div className="col-md-6">
                            ...
                            <p>Finding a property that offers both space and modern amenities in Mumbai can be challenging. This property ensures easy access to essential services while offering luxurious features.</p>
                        </div>
                        <div className="col-md-6">
                            <h4>Core Details</h4>
                            <ul>
                                {Object.entries(propertyDetails.coreDetails).map(([key, value], index) => (
                                    <li key={index}>
                        ...
                        <div className="col-md-12">
                            ...
                            <ul className="list-inline">
                                {propertyDetails.features.map((feature, index) => (
                                    <li key={index} className="list-inline-item m-2 p-2 border rounded shadow-sm bg-light">
                    ...
                    <div className="row mt-5">
                        <div className="col-md-12 d-flex justify-content-center gap-3">
                            ...
                            <button
                                ...
                                onClick={() => {
                                    document.querySelector('.rent-form').scrollIntoView({ behavior: 'smooth' });
                                    setRentForm(true);
                                }}
                            >
                                Make Inquiry
