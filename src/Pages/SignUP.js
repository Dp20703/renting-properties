                    ...
                    <div className="wrapper">
                        ...
                        <div className="d-grid forms23-grids">
                            <div className="form23">
                                ...
                                <form action={"http://localhost:8000/register_user"} method="post">
                                    ...
                                    <label htmlFor="role" className=' fw-lighter mr-5 ml-2'>Role:</label>
                                    <select name="role" className='w-50' value={role} onChange={(e) => setRole(e.target.value)} required>
                                ...
                                <p className='text-center pt-2'>
                                    Already have an account? <Link id="link" to="/login">Login now</Link>
                                </p>
                            </div>
                        </div>
                    </div>
