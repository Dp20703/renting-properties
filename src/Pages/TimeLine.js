...
function Main() {
    return (
        <>
            <section className="timeline-1 py-5" style={{ padding: '0 140px' }}>
                <div className="container py-md-3">

                    <ul className="timeline">
                        <li>
                            <div className="timeline-badge"><span className="fa fa-check"></span></div>
                            <div className="timeline-panel">
                                <div className="timeline-heading">
                                    <h4 className="timeline-title">Building Surviying</h4>
                                    <p><small className="text-3"><span className="fa fa-clock-o"></span> 11 hours ago via Twitter</small></p>
                                </div>
                        ...
                        <li className="timeline-inverted">
                            <div className="timeline-badge warning"><span className="fa fa-credit-card"></span></div>
                            <div className="timeline-panel">
                                <div className="timeline-heading">
                                    <h4 className="timeline-title">Total Investment</h4>
                                    <p><small className="text-3"><span className="fa fa-clock-o"></span> 11 hours ago via Twitter</small></p>
                                </div>
                                <div className="timeline-body">
                                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo.
                        ...
                        <li>
                            <div className="timeline-badge danger"><span className="fa fa-home"></span></div>
                            <div className="timeline-panel">
                                <div className="timeline-heading">
                                    <h4 className="timeline-title">Property & Asset</h4>
                                    <p><small className="text-3"><span className="fa fa-clock-o"></span> 11 hours ago via Twitter</small></p>
                                </div>
                                <div className="timeline-body">
                                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo.
                        ...
                        <li>
                            <div className="timeline-badge info"><span className="fa fa-cog"></span></div>
                            <div className="timeline-panel">
                                <div className="timeline-heading">
                                    <h4 className="timeline-title">Industrial Agency</h4>
                                    <p><small className="text-3"><span className="fa fa-clock-o"></span> 11 hours ago via Twitter</small></p>
                                </div>
                                <div className="timeline-body">
                                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo.
                        ...
                        <li className="timeline-inverted">
                            <div className="timeline-badge success"><span className="fa fa-thumbs-up"></span></div>
                            <div className="timeline-panel">
                                <div className="timeline-heading">
                                    <h4 className="timeline-title">Office Agency</h4>
                                    <p><small className="text-3"><span className="fa fa-clock-o"></span> 11 hours ago via Twitter</small></p>
                                </div>
                                <div className="timeline-body">
                                    <p>Mussum ipsum cacilds, vidis litro abertis. Consetis adipiscings elitis. Pra lá , depois divoltis porris, paradis. Paisis, filhis, espiritis santis. Mé faiz elementum girarzis, nisi eros vermeio, in elementis mé pra quem é amistosis quis leo.
