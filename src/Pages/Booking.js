...
function Main() {
    ...
    const handleSubmit = (e) => {
        ...
        if (!formData.startDate || !formData.endDate || !formData.propertyId || !formData.ownerId) {
    ...
    return (
        <div className="container my-5">
            ...
            {/* Booking Form */}
            <div ref={formRef} className="booking-form mt-5 p-4 border rounded shadow">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="date" name="bookingDate" className="form-control" value={formData.bookingDate} readOnly />
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <select name="propertyId" className="form-control" value={formData.propertyId} onChange={handleChange} required>
