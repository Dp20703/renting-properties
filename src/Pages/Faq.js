                        ...
                        <div className="row faq-column-grid">
                            ...
                            <div className="faq-column col-lg-6 pl-lg-5 mt-lg-0 mt-5">
                                ...
                                <p>Curabitur dapibus non massa sed maximus. Nam venenatis justo vitae sodales mattis. Vestibulum at
                                    ...
                                    Mauris at mauris erat. </p>
                                <ul>
                                    <li><span className="fa fa-check pr-2"></span>Nam venenatis justo</li>
                                    <li><span className="fa fa-check pr-2"></span>Aliquam in tincidunt dui</li>
                                    <li><span className="fa fa-check pr-2"></span>Consectetur vitae fringilla </li>
                                </ul>
