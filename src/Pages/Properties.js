                        ...
                        <div className="row">
                            <div className="grids3-info  col-lg-4 col-md-6">
                                ...
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">60 Thornley Street, Marrickville, NSW 2204</Link></h5>
                                    <ul>
                            ...
                            <div className="grids3-info col-lg-4 col-md-6 mt-md-0 mt-5">
                                ...
                                <p>Rent</p>
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">423/1 Phillip Street, Petersham, NSW 2049</Link></h5>
                                    <ul>
                            ...
                            <div className="grids3-info col-lg-4 col-md-6 mt-lg-0 mt-5">
                                ...
                                <p>Rent</p>
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">40 Piper Street, Lilyfield, NSW 2040</Link></h5>
                                    <ul>
                                        <li><span className="fa fa-bed"></span> 4 Beds</li>
                                        <li><span className="fa fa-bath"></span> 3 Baths</li>
                                        <li><span className="fa fa-share-square-o"></span> 1200 sq ft</li>
                            ...
                            <div className="grids3-info  col-lg-4 col-md-6 mt-5">
                                ...
                                <p>Rent</p>
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">324 Piper Street hasan, NSW 2040</Link></h5>
                                    <ul>
                            ...
                            <div className="grids3-info  col-lg-4 col-md-6 mt-5">
                                <Link id="link" to="/properties-single"><img src="assets/images/g13.jpg" className="img-fluid" alt="" /></Link>
                                <p>Rent</p>
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">324 Piper Street hasan, NSW 2040</Link></h5>
                                    <ul>
                            ...
                            <div className="grids3-info  col-lg-4 col-md-6 mt-5">
                                <Link id="link" to="/properties-single"><img src="assets/images/g14.jpg" className="img-fluid" alt="" /></Link>
                                <p>Rent</p>
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">60 Thornley Street, Marrickville, NSW 2204</Link></h5>
                                    <ul>
                            ...
                            <div className="grids3-info  col-lg-4 col-md-6 mt-5">
                                <Link id="link" to="/properties-single"><img src="assets/images/g15.jpg" className="img-fluid" alt="" /></Link>
                                <p>Rent</p>
                                <div className="info-bg">
                                    <h5><Link id="link" to="/properties-single">40 Piper Street, Lilyfield, NSW 2040</Link></h5>
                                    <ul>
