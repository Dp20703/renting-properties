                    ...
                    >
                        {
                            propertySlides.map((slide, index) => (
                                <SwiperSlide key={index}>
                                    <div className="item">
                                        <li>
                                            <div className={`slider-info banner-view banner-top${index} bg bg2`}>
                                                <div className="banner-info">
                                                    <div className="container">
                                                        <div className="banner-info-bg">
                                                            <h6><span className="fa fa-map-marker" />{slide.location}</h6>
                                                            <h5>{slide.title}</h5>
                                                            <ul className="banner-ul">
                                                                <li><span className="fa fa-bed" />{slide.beds}</li>
                                                                <li><span className="fa fa-bath" /> {slide.baths}</li>
                                                                <li><span className="fa fa-share-square-o" /> {slide.size}</li>
                                                            </ul>
                                ...
                                <div className="grids4-info col-lg-4 col-md-6 mt-4" key={index}>
                                    ...
                                    <div className="info-bg">
                                        ...
                                        <ul>
                                            ...
                                            <li><span className="fa fa-bath" /> {property.baths} Baths</li>
                                            <li><span className="fa fa-share-square-o" /> {property.size}  sq ft</li>
                                        </ul>
                                    </div>
                                </div>
                            ))}
