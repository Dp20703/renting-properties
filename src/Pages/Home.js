                                        ...
                                        <div className="banner-info">
                                            <div className="container">
                                                <div className="banner-info-bg">
                                                    <h6><span className="fa fa-map-marker" /> Mumbai, India</h6>
                                                    <h5>Luxury Apartments in Bandra</h5>
                                                    <ul className="banner-ul">
                                                        <li><span className="fa fa-bed" /> 3</li>
                                                        <li><span className="fa fa-bath" /> 2</li>
                                                        <li><span className="fa fa-share-square-o" /> 1500 sq ft</li>
                                                    </ul>
                                ...
                                <li>
                                    <div className="slider-info banner-view banner-top1 bg bg2">
                                        <div className="banner-info">
                                            <div className="container">
                                                <div className="banner-info-bg">
                                                    <h6><span className="fa fa-map-marker" /> Bangalore, India</h6>
                                                    <h5>Spacious Villas in Whitefield</h5>
                                                    <ul className="banner-ul">
                                                        <li><span className="fa fa-bed" /> 4</li>
                                ...
                                <li>
                                    <div className="slider-info banner-view banner-top2 bg bg2">
                                        <div className="banner-info">
                                            <div className="container">
                                                <div className="banner-info-bg">
                                                    <h6><span className="fa fa-map-marker" /> Delhi, India</h6>
                                                    <h5>Modern Flats in Connaught Place</h5>
                                                    <ul className="banner-ul">
                                                        <li><span className="fa fa-bed" /> 2</li>
                                                        <li><span className="fa fa-bath" /> 2</li>
                                ...
                                <li>
                                    <div className="slider-info banner-view banner-top3 bg bg2">
                                        <div className="banner-info">
                                            <div className="container">
                                                <div className="banner-info-bg">
                                                    <h6><span className="fa fa-map-marker" /> Chennai, India</h6>
                                                    <h5>Beachside Villas in ECR</h5>
                                                    <ul className="banner-ul">
                                                        <li><span className="fa fa-bed" /> 5</li>
                                                        <li><span className="fa fa-bath" /> 4</li>
                                ...
                                <li>
                                    <div className="slider-info banner-view banner-top4 bg bg2">
                                        <div className="banner-info">
                                            <div className="container">
                                                <div className="banner-info-bg">
                                                    <h6><span className="fa fa-map-marker" /> Kolkata, India</h6>
            ...
            <section className="w3l-index-block2 py-5">
                <div className="container py-md-3">
                    <div className="heading text-center mx-auto">
                        ...
                        <p className="my-3 head"> We provide expert rental property solutions, ensuring a smooth and hassle-free experience for tenants and landlords alike. From finding the perfect home to managing properties efficiently, we've got you covered.
                        </p>
                    </div>
                    <div className="row bottom_grids mt-5 pt-3">
                        <div className="col-lg-4 col-md-6">
                            <div className="s-block p-4">
                                ...
                                <p className="">Discover a wide range of rental homes, apartments, and condos that suit your lifestyle and budget.</p>
                        ...
                        <div className="col-lg-4 col-md-6 mt-sm-0 mt-4">
                            <div className="s-block p-4">
                                ...
                                <p className="">Find ideal office spaces, retail shops, and commercial properties to meet your business needs.</p>
                                <Link id="link" to="/services">Read More <span className="fa fa-long-arrow-right" /></Link>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 mt-lg-0 mt-4">
                            <div className="s-block p-4">
                                ...
                                <p className="">We handle everything from tenant screening to maintenance, making property ownership stress-free.</p>
                                <Link id="link" to="/services">Read More <span className="fa fa-long-arrow-right" /></Link>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 mt-4">
                            <div className="s-block p-4">
                                ...
                                <p className="">Looking for a vacation rental or a temporary stay? We have fully furnished properties available.</p>
                                <Link id="link" to="/services">Read More <span className="fa fa-long-arrow-right" /></Link>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 mt-4">
                            <div className="s-block p-4">
                                ...
                                <p className="">We assist tenants in finding the right property and provide ongoing support throughout the lease.</p>
                                <Link id="link" to="/services">Read More <span className="fa fa-long-arrow-right" /></Link>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 mt-4">
                            <div className="s-block p-4">
                                ...
                                <p className="">Explore lucrative real estate investment options with expert guidance from our team.</p>
                                <Link id="link" to="/services">Read More <span className="fa fa-long-arrow-right" /></Link>
                            </div>
                        </div>
                    </div>
            ...
            <div id="grids4-block" className="py-5">
                <div className="container py-md-3">
                    <div className="heading text-center mx-auto">
                        ...
                        <p className="my-3 head"> Explore our latest listings of premium rental properties across India, offering comfort and convenience.</p>
                    </div>
                    ...
                    <div className="container py-md-3">
                        <div className="customers-top_sur row">
                            <div className="customers-left_sur col-lg-6">
                                ...
                                <p>We specialize in connecting tenants with the best rental properties available. Whether you're looking for an apartment, a house, or a commercial space, we make the process simple and hassle-free.</p>
                                <Link id="link" to="/contact" className="btn btn-secondary btn-theme1 mt-4">
                                    Contact Us
                                </Link>
                            </div>
                            <div className="customers-middle_sur col-lg-6 mt-lg-0 mt-4">
                                <div className="customers_grid">
                                    <p className="sub-test">
                                        Our team ensures that you find a rental property that fits your needs and budget. With a wide range of listings, secure transactions, and personalized assistance, we make renting stress-free.
                                    </p>
                                    <p>Contact us today to explore available properties and find your ideal home or commercial space!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="customers_sur py-5">
                    <div className="container py-md-3">
                        <div className="heading text-center mx-auto">
                            ...
                            <p className="my-3 head">Our clients love us! Here's what they have to say about our services.</p>
                        </div>
                        <div className="customers-top_sur row mt-5 pt-3">
                            <div className="customers-left_sur col-md-6">
                                <div className="customers_grid">
                                    ...
                                    <p className="sub-test">The team was incredibly professional and helped me find the perfect property. Highly recommend!</p>
                                    <div className="customers-bottom_sur row">
                                        <div className="custo-img-res col-3">
                                            <img src="assets/images/te2.jpg" alt=" " className="img-responsive rounded-circle" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
                                        </div>
                            ...
                            <div className="customers-middle_sur col-md-6 mt-md-0 mt-4">
                                ...
                                <li className="rated">
                                    ...
                                    <p className="sub-test">Excellent service and great communication throughout the process. Couldn't be happier!</p>
                                    <div className="customers-bottom_sur row">
                                        <div className="custo-img-res col-3">
                                            <img src="assets/images/te3.jpg" alt=" " className="img-responsive rounded-circle" style={{ width: '100px', height: '100px', objectFit: 'cover' }} />
                                        </div>
                                        <div className="custo_grid col-9">
                                            <h5>Priya Patel</h5>
                                            <span>Client</span>
