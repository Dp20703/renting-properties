...
function Main() {
    ...
    const userBookings = bookings.filter(booking => booking.userId === loggedInUserId);
                                ...
                                <tr key={booking.bookingId}>
                                    ...
                                    <td>
                                        {booking.status === "Pending" ? (
                                            <button className="btn btn-danger btn-sm" onClick={() => handleCancelBooking(booking.bookingId)}>
                                                Cancel
                                            </button>
                                        ) : (
