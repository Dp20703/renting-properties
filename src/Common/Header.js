      ...
      <section className="w3l-bootstrap-header">
        <nav className="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
          <div className="container">
            <a className="navbar-brand" href="index.html"><span className="">E-</span>Property</a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav mr-auto">
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a className="dropdown-item" href="properties.html">Properties</a>
                    <a className="dropdown-item" href="properties-single.html">Properties Single</a>
                    ...
                    <a className="dropdown-item" href="email-template.html">Email Template</a>
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a className="dropdown-item" href="ecommerce.html">Shop</a>
                    <a className="dropdown-item" href="ecommerce-single.html">Shop Single</a>
              ...
              <form className="form-inline">
                <a className="btn btn-secondary btn-theme" href="find-property.html"><span className="fa fa-search"></span> Find Property</a>
              </form>
            </div>
          </div>
        </nav>
