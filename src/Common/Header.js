    ...
    <section className="w3l-bootstrap-header">
      <nav className="navbar navbar-expand-lg navbar-light py-lg-2 py-2">
        <div className="container">
          <Link className="navbar-brand" to="/"><span>E-</span>Property</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto ms-auto " style={{fontSize:'22px'}}>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><Link className="dropdown-item" to="/properties">Properties</Link></li>
                  <li><Link className="dropdown-item" to="/properties-single">Properties Single</Link></li>
                  <li><Link className="dropdown-item" to="/agent-single">Agent Single</Link></li>
                  ...
                  <li><Link className="dropdown-item" to="/search-results">Search Results</Link></li>
                </ul>
              </li>
